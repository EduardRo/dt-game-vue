...
export default {
  ...
  methods: {
    getCellStyle(cell, rowIndex, colIndex) {
      ...
      if (
        this.isBlankKeyPressed &&
        this.selectedSquare &&
        rowIndex === this.selectedSquare.row &&
        colIndex === this.selectedSquare.col
      ) {
        cellStyles.selected = true
      }
    ...
    moveDyna(direction) {
      ...
      switch (direction) {
        ...
        case 'right':
          ...
          break
        case 'blank':
          this.selectedSquare = { row: this.playerPosition.row, col: this.playerPosition.col }
          this.isBlankKeyPressed = true
          break
      }
      ...
      if (
        ...
        //---- bagat de mine
        if (this.isBlankKeyPressed) {
          this.gameBoard[newRow][newCol] = 'selected'
        }
      }
    },
